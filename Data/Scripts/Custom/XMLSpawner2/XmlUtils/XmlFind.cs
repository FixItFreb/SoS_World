...
namespace Server.Mobiles
{
	public class XmlFindGump : Gump
	{
		...
		public class SearchCriteria
		{
			...
			public bool Dosearchlod;
			public bool Dosearchsos;
			public bool Dosearchserp;
			public bool Dosearchund;
			public bool Dosearchdred;
			public bool Dosearchsvg;
			public bool Dosearchatl;
			...
			public SearchCriteria(bool dotype, bool doname, bool dorange, bool doregion, bool doentry, bool doentrytype, bool docondition, bool dolod, bool dosos,
				bool doserp, bool dound, bool dodred, bool dosvg, bool doatl, bool doint, bool donull, bool doerr, bool doage, bool dowithattach, bool doattach, bool dohidevalid,
			...
			if (!criteria.Dosearchattach)
			{
				...
				if (itemarray != null)
				{
					foreach (Item i in itemarray)
					{
						...
						// check for map
						if ((i.Map == Map.Lodor && criteria.Dosearchlod) || (i.Map == Map.Sosaria && criteria.Dosearchsos) ||
							(i.Map == Map.Underworld && criteria.Dosearchund) || (i.Map == Map.SerpentIsland && criteria.Dosearchserp) ||
							(i.Map == Map.IslesDread && criteria.Dosearchdred) || (i.Map == Map.SavagedEmpire && criteria.Dosearchsvg) ||
							(i.Map == Map.Atlantis && criteria.Dosearchatl) || (i.Map == Map.Internal && criteria.Dosearchint) ||
			...
			: base(X, Y)
		{
			...
			y += 20;
			AddCheck(5, y, 0xD2, 0xD3, m_SearchCriteria.Dosearchlod, 308);
			AddLabel(28, y, 0x384, "Lod");
			AddCheck(75, y, 0xD2, 0xD3, m_SearchCriteria.Dosearchsos, 309);
			AddLabel(98, y, 0x384, "Sos");

			y += 20;
			AddCheck(5, y, 0xD2, 0xD3, m_SearchCriteria.Dosearchserp, 310);
			AddLabel(28, y, 0x384, "Serp");
			AddCheck(75, y, 0xD2, 0xD3, m_SearchCriteria.Dosearchund, 311);
			AddLabel(98, y, 0x384, "Und");

			y += 20;
			AddCheck(5, y, 0xD2, 0xD3, m_SearchCriteria.Dosearchdred, 318);
			AddLabel(28, y, 0x384, "Dred");
			AddCheck(75, y, 0xD2, 0xD3, m_SearchCriteria.Dosearchsvg, 327);
			AddLabel(98, y, 0x384, "Svg");

			y += 20;
			// add the hide valid internal map button
			AddCheck(5, y, 0xD2, 0xD3, m_SearchCriteria.Dosearchatl, 328);
			AddLabel(28, y, 0x384, "Atl");
			AddCheck(75, y, 0xD2, 0xD3, m_SearchCriteria.Dohidevalidint, 316);
			AddLabel(98, y, 0x384, "Hde Vld Int");
		...
		public override void OnResponse(NetState state, RelayInfo info)
		{
			...
			m_SearchCriteria.Dosearchlod = info.IsSwitched(308);
			m_SearchCriteria.Dosearchsos = info.IsSwitched(309);
			m_SearchCriteria.Dosearchserp = info.IsSwitched(310);
			m_SearchCriteria.Dosearchund = info.IsSwitched(311);
			m_SearchCriteria.Dosearchdred = info.IsSwitched(318);
			m_SearchCriteria.Dosearchsvg = info.IsSwitched(327);
			m_SearchCriteria.Dosearchatl = info.IsSwitched(328);
