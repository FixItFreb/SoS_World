        ...
        */
        ...
        public void ReportStatus()
        {
            ...
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {
                ...
                if (XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Lodor).Count > 0)
                    Console.WriteLine("\t{0} : {1}", (SkillName)i, XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Lodor).Count);

                count += XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Lodor).Count;
            }
            Console.WriteLine("Sosaria");
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {

                if (XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Sosaria).Count > 0)
                    Console.WriteLine("\t{0} : {1}", (SkillName)i, XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Sosaria).Count);

                count += XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Sosaria).Count;
            }
            Console.WriteLine("Underworld");
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {

                if (XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Underworld).Count > 0)
                    Console.WriteLine("\t{0} : {1}", (SkillName)i, XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Underworld).Count);

                count += XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Underworld).Count;
            }
            Console.WriteLine("SerpentIsland");
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {

                if (XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.SerpentIsland).Count > 0)
                    Console.WriteLine("\t{0} : {1}", (SkillName)i, XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.SerpentIsland).Count);

                count += XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.SerpentIsland).Count;
            }
            ...
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {
                ...
                if (XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.IslesDread).Count > 0)
                    Console.WriteLine("\t{0} : {1}", (SkillName)i, XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.IslesDread).Count);

                count += XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.IslesDread).Count;
            }
            ...
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {
                ...
                if (XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.SavagedEmpire).Count > 0)
                    Console.WriteLine("\t{0} : {1}", (SkillName)i, XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.SavagedEmpire).Count);

                count += XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.SavagedEmpire).Count;
            }
            ...
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {
                ...
                if (XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Atlantis).Count > 0)
                    Console.WriteLine("\t{0} : {1}", (SkillName)i, XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Atlantis).Count);

                count += XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Atlantis).Count;
            }
	   ...
	   if(index < MaxTraces){
        ...
        private static void SpawnEditorGo_OnCommand(CommandEventArgs e)
        {
            ...
            if (from != null && e.Length >= 1)
            {
                ...
                else if (string.Compare(MapName, Map.Atlantis.Name, true) == 0)
                    NewMap = Map.Atlantis;
                else
                {
        ...
        public static void XmlUnLoadFromStream(Stream fs, string filename, string SpawnerPrefix, Mobile from, out int processedmaps, out int processedspawners)
        {
                ...
                if (ds.Tables[SpawnTablePointName] != null && ds.Tables[SpawnTablePointName].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[SpawnTablePointName].Rows)
                    {
                        ...
                        if (SpawnerPrefix == null || (SpawnerPrefix.Length == 0) || (SpawnName.StartsWith(SpawnerPrefix) == true))
                        {
                            ...
                            // Convert the xml map value to a real map object
                            if (string.Compare(XmlMapName, Map.Sosaria.Name, true) == 0 || XmlMapName == "Sosaria")
                            {
                                SpawnMap = Map.Sosaria;
                                SosariaCount++;
                            }
                            else if (string.Compare(XmlMapName, Map.Lodor.Name, true) == 0 || XmlMapName == "Lodor")
                            {
                                SpawnMap = Map.Lodor;
                                LodorCount++;
                            }
                            else if (string.Compare(XmlMapName, Map.Underworld.Name, true) == 0 || XmlMapName == "Underworld")
                            {
                                SpawnMap = Map.Underworld;
                                UnderworldCount++;
                            }
                            else if (string.Compare(XmlMapName, Map.SerpentIsland.Name, true) == 0 || XmlMapName == "SerpentIsland")
                            {
                                SpawnMap = Map.SerpentIsland;
                                SerpentIsleCount++;
                            }
                            else if (string.Compare(XmlMapName, Map.IslesDread.Name, true) == 0 || XmlMapName == "IslesDread")
                            {
                                SpawnMap = Map.IslesDread;
                                IslesDreadCount++;
                            }
                            else if (string.Compare(XmlMapName, Map.SavagedEmpire.Name, true) == 0 || XmlMapName == "SavagedEmpire")
                            {
                                SpawnMap = Map.SavagedEmpire;
                                SavagedEmpireCount++;
                            }
                            else if (string.Compare(XmlMapName, Map.Atlantis.Name, true) == 0 || XmlMapName == "Atlantis")
                            {
                                SpawnMap = Map.Atlantis;
                                AtlantisCount++;
                            }
                            else
                            {
            ...
            if (from != null)
                from.SendMessage("{0}/{10} spawner(s) were unloaded using file {1} [Sosaria={2}, Lodor={3}, Underworld={4}, SerpentIsle={5}, IslesDread={6}, SavagedEmpire={7}, Atlantis={8}, Other={9}].",
                    spawners_deleted, filename, SosariaCount, LodorCount, UnderworldCount, SerpentIsleCount, IslesDreadCount, SavagedEmpireCount, AtlantisCount, OtherCount, TotalCount);
        ...
        public static void XmlLoadFromStream(Stream fs, string filename, string SpawnerPrefix, Mobile from, Point3D fromloc, Map frommap, bool loadrelative, int maxrange, bool loadnew, out int processedmaps, out int processedspawners, bool verbose)
        {
            ...
            if (from != null)
                from.SendMessage("{0} spawner(s) were created from file {1} [Sosaria={2}, Lodor={3}, Underworld={4}, SerpentIsle={5}, IslesDread={6} SavagedEmpire={7} AtlantisCount={8} Other={9}].",
                    TotalCount, filename, SosariaCount, LodorCount, UnderworldCount, SerpentIsleCount, IslesDreadCount, SavagedEmpireCount, AtlantisCount, OtherCount);
        ...
        public static bool SaveSpawnList(Mobile from, ArrayList savelist, string dirname, Stream stream, bool oldformat, bool verbose)
        {
            ...
            foreach (XmlSpawner sp in savelist)
            {
                ...
                if (string.Compare(sp.Map.Name, Map.Sosaria.Name, true) == 0)
                    ...
                    SavagedEmpireCount++;
                else if (string.Compare(sp.Map.Name, Map.Atlantis.Name, true) == 0)
                    AtlantisCount++;
                else
                    OtherCount++;
            ...
            if (from != null)
            {
                from.SendMessage("{0} spawner(s) were saved to file {1} [Sosaria={2}, Lodor={3}, Underworld={4}, SerpentIsle={5}, IslesDread={6}, SavagedEmpire={7} Atlantis={8} Other={9}].",
                    TotalCount, dirname, SosariaCount, LodorCount, UnderworldCount, SerpentIsleCount, IslesDreadCount, SavagedEmpireCount, AtlantisCount, OtherCount);
            }
            return true;
